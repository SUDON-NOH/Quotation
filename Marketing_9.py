...
from PyQt5.QtWidgets import QApplication, QWidget, QLabel, QLineEdit, QGridLayout, QPushButton, \
    ...
    QHBoxLayout, QTableWidget, QRadioButton, QTableWidgetItem, QAbstractItemView, QDialog, QComboBox
...
class tab_widget(QWidget):
    ...
    def Quotation(self):
        ...
        self.Quotation_label4 = QLabel('CATEGORY: ')
        self.Quotation_Comb1 = QComboBox()

        # COMBOBOX ITEM
        self.Quotation_Comb1.addItem('PQ')
        self.Quotation_Comb1.addItem('NA')
        self.Quotation_Comb1.currentIndexChanged.connect(self.combo_act)

        layout = QGridLayout()
        layout.addWidget(self.Quotation_number, 0, 0)
        layout.addWidget(self.Quotation_label1, 0, 1)
        layout.addWidget(self.Quotation_label2, 0, 2)
        layout.addWidget(self.Quotation_label3, 1, 0)
        layout.addWidget(self.Quotation_Comb1, 1, 1)

        self.Quotation_1.setLayout(layout)

    def combo_act(self):
        self.combo_text = self.Quotation_Comb1.currentText()
