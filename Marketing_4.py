...
from PyQt5.QtWidgets import QApplication, QWidget, QLabel, QLineEdit, QGridLayout, QPushButton, \
    QMessageBox, QDesktopWidget, QTabWidget, QTextEdit, QVBoxLayout, QGroupBox, QMainWindow, QHBoxLayout, QTableWidget, QRadioButton
...
class tab_widget(QWidget):
    ...
    def code_c_search(self):
        ...
        # GropBox 크기 조절
        self.c_code_search.setMaximumSize(450, 800)
    ...
    def insert_table(self):
        ...
        for i in range(self.numROW):
            RBtn = QRadioButton()
            self.radiobtn.append(RBtn)
        for i in range(self.numROW):
            self.c_code_table.setCellWidget(i, 0, self.radiobtn[i])
    ...
    def Quotation(self):
        ...
        Vbox = QVBoxLayout()
        Vbox.addWidget(self.Quotation_text1)
        self.Quotation_1.setLayout(Vbox)
