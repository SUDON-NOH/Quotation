...
from PyQt5.QtWidgets import QApplication, QWidget, QLabel, QLineEdit, QGridLayout, QPushButton, \
    QMessageBox, QDesktopWidget, QTabWidget, QTextEdit, QVBoxLayout, QGroupBox, QMainWindow, QHBoxLayout, QTableWidget
...
class tab_widget(QWidget):
    ...
    def code_c_search(self):
        ...
        # GropBox 크기 조절
        self.c_code_search.setMaximumSize(400, 800)
        ...
        self.c_code_table.setRowCount(10)
        self.c_code_table.setColumnCount(3)
