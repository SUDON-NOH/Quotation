...
class tab_widget(QWidget):
    ...
    def exeUI(self):
        ...
        self.Q_pbtn2 = QPushButton("저장")
        self.Q_pbtn3 = QPushButton("출력")
        self.Q_pbtn4 = QPushButton("불러오기")
        ...
        # self.Q_pbtn2.setFixedSize(60, 30)
        # self.Q_pbtn3.setFixedSize(60, 30)
        ...
        pbtnlayout.addWidget(self.Q_pbtn4)
        pbtnlayout.addWidget(self.Q_pbtn2)
        pbtnlayout.addWidget(self.Q_pbtn3)

        tablayout2 = QVBoxLayout()
        tablayout2.addLayout(tablayout1)
        tablayout2.addWidget(right_groupbox_tbl)
        tablayout2.addLayout(pbtnlayout)
    ...
    def Q_tbl_show(self):
        ...
        for i in range(self.Q_spin1_text):
            ...
            # globals()['combo_class{}'.format(i)].setCurrentIndex(1)
